...
TEST(WriteScene, SceneWriter)
{
    ...
    Xml::Reader reader;
    Xml::HElement readRoot = reader.loadXml(xmlStream);
    ...
    Xml::ChildElements childElements = root->getChildElements();
    ...
    Xml::ChildElements layerElements = child->getChildElements();
    ...
    Xml::ChildElements placedGraphicElements = layerElements[0]->getChildElements();
    ...
    Xml::ChildElements pointElements = vectorGraphic.getChildElements();
